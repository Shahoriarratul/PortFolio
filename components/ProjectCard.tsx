...
export default function ProjectCard(prop: propType) {
  ...
  return (
    <div
      onClick={handleClick}
      className=" mt-3 flex h-48 w-64 flex-col items-center rounded-xl bg-[rgba(248,250,252,.08)] transition duration-300 ease-in-out hover:shadow-lg hover:shadow-indigo-500/50 sm:h-[35vh] sm:w-[40vw] sm:flex-row"
    >
      <Image
        src={prop.src}
        height={500}
        width={500}
        className="mt-2 h-32 w-56 rounded-xl sm:m-3 sm:h-[93%] sm:w-[45%] "
        alt="project image"
      ></Image>
