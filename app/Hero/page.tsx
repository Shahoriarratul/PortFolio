    ...
    >
      <div className=" mr-[5vh] h-[40vh] w-full sm:mb-[-7vh] sm:h-[35vw] sm:w-[35vw]">
        <Spline
          ...
          scene="https://prod.spline.design/d-mvfO2CGrqE6Oxw/scene.splinecode"
        />
      </div>
      <div className="mx-48 mb-10 flex w-[90vw] flex-col items-center px-12 text-center text-sm font-thin !leading-[1.5] sm:w-[60vw] sm:text-right sm:text-lg md:w-[60vw] md:text-3xl ">
        ...
        <div className="flex h-12 flex-col gap-5 sm:flex-row ">
          <Link
            href="#footer"
            className=" group flex cursor-pointer items-center gap-2 rounded-full border border-violet-800 bg-opacity-45 px-7 py-3 text-center text-xs text-white transition duration-300 ease-in-out hover:scale-105 hover:bg-violet-800/50 focus:scale-105 active:scale-105 sm:text-xl"
          >
            Contact me here
            <span>
          ...
          <a
            className=" group flex cursor-pointer items-center gap-2 rounded-full border border-violet-800 bg-opacity-45 px-7 py-3 text-xs outline-none transition duration-300 hover:scale-105 hover:bg-violet-800/50 focus:scale-105 active:scale-105 dark:bg-white/10 sm:text-xl"
