  ...
  return (
    <>
      ...
      <button
        ...
        className={` ${!isOpen ? "content" : "hidden"} fixed right-3 top-3 z-50 flex h-12 w-12 items-center justify-center rounded-full bg-violet-800/30 bg-opacity-45 p-2 sm:hidden`}
      >
