...
export default function Header() {
  return (
    <div className="fixed z-10 mt-5 flex h-16 w-[50vw] flex-row  items-stretch justify-center rounded-full bg-violet-800/25 bg-opacity-45 p-5 text-white shadow-lg shadow-indigo-500/50 transition duration-500 ease-in-out hover:bg-opacity-60 hover:ring-2 hover:ring-inset hover:ring-pink-300/35">
